...
export default function OnboardingPage() {
  ...
  const handleSelectCompany = async () => {
    ...
    if (selectedCompanyData) {
      localStorage.setItem('activeCompany', JSON.stringify(selectedCompanyData))
      router.push('/dashboards')
    }
  }

  const handleSuperAdminPanel = () => {
    localStorage.setItem('activeCompany', JSON.stringify({ id: 'super-admin', name: 'Panel Super Admin', role: 'SUPER_ADMIN' }))
    router.push('/dashboards')
  }
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
            ...
            {canAccessSuperAdmin && (
              <div className="mb-6 flex justify-end">
                <Button variant="outline" size="sm" onClick={handleSuperAdminPanel}>
